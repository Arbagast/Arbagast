### Обо мне
 ...
 Пройдены курсы Нетологии по специальности 1С программист от 0 до middle. В данный момент работаю на фирме Matrix. Занимаюсь устранением проблем с оборудованием для 1С
