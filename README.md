### Обо мне
 ...
 Пройдены курсы Нетологии по специальности 1С программист от 0 до middle. В данный момент работаю в Сухумском физико-техническом институте по специальности стекло-кварцедув.

## Дипломы

[Диплом Института](https://disk.yandex.ru/client/disk/Дипломы/Институт)
...
[Дипломная работа(Выполнена на EDT, .dt файл находится в Releases, так же приложены автотесты)](https://github.com/Arbagast/fonecmid-diplom/tree/onec-mid-31)
